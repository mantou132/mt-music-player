import { dew as _objectAssignDew } from '../../object-assign.js';
import { dew as _phoneticSymbolDew } from './phonetic-symbol.dew.js';
...
export function dew() {
  ...
  const assign = _objectAssignDew(); // XXX: Symbol when web support.
  ...
  const PHONETIC_SYMBOL = _phoneticSymbolDew();
